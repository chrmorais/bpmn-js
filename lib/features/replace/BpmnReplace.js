...
function BpmnReplace(bpmnFactory, replace, selection, modeling) {
  ...
  function replaceElement(element, target, hints) {
    ...
    var oldCollapsed = typeof element.collapsed !== 'undefined' ?
                       element.collapsed : !element.isExpanded;

    var targetCollapsed = typeof target.collapsed !== 'undefined' ?
                          target.collapsed : !target.isExpanded;

    if ((is(oldBusinessObject, 'bpmn:SubProcess') ||
         is(oldBusinessObject, 'bpmn:AdHocSubProcess')) &&
        type === 'bpmn:SubProcess' &&
        oldCollapsed !== targetCollapsed) {
